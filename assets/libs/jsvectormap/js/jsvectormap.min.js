        ...
        w.delegate(i, "mousedown", ".jvm-element", function () {
          ...
          w.delegate(i, "mouseup", ".jvm-element", function (t) {
            ...
            if (
              !e.isBeingDragged &&
              !t.defaultPrevented &&
              (("region" === i.type && e.params.regionsSelectable) ||
                ("marker" === i.type && e.params.markersSelectable))
            ) {
              var s = i.element;
      ...
      createLines: function (t, e, i) {
        ...
        t)) {
          ...
          !1 !== n &&
            ...
            (this.lines[j(h.from, h.to)] = { element: a, config: h }));
        }
      },
    ...
    D = (function () {
      ...
      return (
        ...
        (e.addLine = function (t, e, i) {
          void 0 === i && (i = {}),
            this.createLines([{ from: t, to: e, style: i }], this.markers, !0);
        }),
        (e.reset = function () {
  ...
  return (
    ...
    (D.defaults = {
      ...
      markerStyle: {
        ...
        hover: { fill: "#FF844B", cursor: "pointer" },
        selected: { fill: "blue" },
        selectedHover: {},
      },
      markerLabelStyle: {
